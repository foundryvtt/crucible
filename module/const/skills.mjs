...
export const DEFAULT_KNOWLEDGE = Object.freeze({
  alchemy: {label: "SKILL.DEFAULT_KNOWLEDGE.Alchemy", skill: "arcana"},
  ancients: {label: "SKILL.DEFAULT_KNOWLEDGE.Ancients", skill: "society"},
  artifacts: {label: "SKILL.DEFAULT_KNOWLEDGE.Artifacts", skill: "society"},
  arts: {label: "SKILL.DEFAULT_KNOWLEDGE.Arts", skill: "performance"},
  beasts: {label: "SKILL.DEFAULT_KNOWLEDGE.Beasts", skill: "wilderness"},
  celestials: {label: "SKILL.DEFAULT_KNOWLEDGE.Celestials", skill: "arcana"},
  cosmology: {label: "SKILL.DEFAULT_KNOWLEDGE.Cosmology", skill: "science"},
  crafts: {label: "SKILL.DEFAULT_KNOWLEDGE.Crafts", skill: "society"},
  crime: {label: "SKILL.DEFAULT_KNOWLEDGE.Crime", skill: "society"},
  dragons: {label: "SKILL.DEFAULT_KNOWLEDGE.Dragons", skill: "medicine"},
  elementals: {label: "SKILL.DEFAULT_KNOWLEDGE.Elementals", skill: "arcana"},
  fey: {label: "SKILL.DEFAULT_KNOWLEDGE.Fey", skill: "arcana"},
  fiends: {label: "SKILL.DEFAULT_KNOWLEDGE.Fiends", skill: "arcana"},
  forensics: {label: "SKILL.DEFAULT_KNOWLEDGE.Forensics", skill: "awareness"},
  gods: {label: "SKILL.DEFAULT_KNOWLEDGE.Gods", skill: "arcana"},
  intrigue: {label: "SKILL.DEFAULT_KNOWLEDGE.Intrigue", skill: "deception"},
  legends: {label: "SKILL.DEFAULT_KNOWLEDGE.Legends", skill: "society"},
  machines: {label: "SKILL.DEFAULT_KNOWLEDGE.Machines", skill: "science"},
  monsters: {label: "SKILL.DEFAULT_KNOWLEDGE.Monsters", skill: "medicine"},
  outsiders: {label: "SKILL.DEFAULT_KNOWLEDGE.Outsiders", skill: "arcana"},
  plants: {label: "SKILL.DEFAULT_KNOWLEDGE.Plants", skill: "wilderness"},
  politics: {label: "SKILL.DEFAULT_KNOWLEDGE.Politics", skill: "diplomacy"},
  rituals: {label: "SKILL.DEFAULT_KNOWLEDGE.Rituals", skill: "arcana"},
  seafaring: {label: "SKILL.DEFAULT_KNOWLEDGE.Seafaring", skill: "wilderness"},
  souls: {label: "SKILL.DEFAULT_KNOWLEDGE.Souls", skill: "arcana"},
  subterranea: {label: "SKILL.DEFAULT_KNOWLEDGE.Subterranea", skill: "wilderness"},
  tracking: {label: "SKILL.DEFAULT_KNOWLEDGE.Tracking", skill: "awareness"},
  trade: {label: "SKILL.DEFAULT_KNOWLEDGE.Trade", skill: "society"},
  undeath: {label: "SKILL.DEFAULT_KNOWLEDGE.Undeath", skill: "medicine"},
  warfare: {label: "SKILL.DEFAULT_KNOWLEDGE.Warfare", skill: "intimidation"},
  weather: {label: "SKILL.DEFAULT_KNOWLEDGE.Weather", skill: "science"}
});
