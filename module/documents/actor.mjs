...
export default class CrucibleActor extends Actor {
   ...
   *                                                            actions are derived.
   * @param {Set<string>} [options.actions]                     The movement action types used. Derived from the
   *                                                            operation waypoints if not provided.
   * @returns {Promise<void>}
   */
  async useMove(costFeet, {movement, actions, ...useOptions}={}) {
    ...
    const crucibleMovement = {id: movement.id, origin: movement.origin, waypoints, cost: costFeet};
