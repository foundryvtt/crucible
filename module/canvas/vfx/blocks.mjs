...
function _finalizeConeSweep(component) {
  const {originX, originY, startAngleRad, endAngleRad, duration, radialSpeed} = component.config.coneSweep;
  let elapsed = 0;
...
function _finalizeImplodeExplode(component) {
  const {originX, originY, innerRadius, radius, implodeDuration, holdDuration, explodeDuration,
    explodeSpeed, shakeIntensity} = component.config.implodeExplode;
