...
export default class CrucibleTokenObject extends foundry.canvas.placeables.Token {
  ...
  _visualizeEngagement(engagement) {
    ...
    this.#engagementDebug.enemies.text = game.i18n.format("DEBUG.Enemies", {enemies: engagement.enemies.size});
    this.#engagementDebug.enemies.position.set(cx, y);
    this.#engagementDebug.enemies.visible = true;
    this.#engagementDebug.engagement.text = game.i18n.format("DEBUG.Engagement", {engagement: engagement.value + engagement.allyBonus});
    this.#engagementDebug.engagement.position.set(cx, y + this.h);
    this.#engagementDebug.engagement.visible = true;
    this.#engagementDebug.flanked.text = game.i18n.format("DEBUG.Flanked", {flanked: engagement.flanked});
